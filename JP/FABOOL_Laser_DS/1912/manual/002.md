...
<table class="packing-list">
    <tbody>
        ...
        <tr>
            <td>アルミフレーム20x40mm 660mm</td>
            <td></td>
            <td><img src="./images/packing/007.jpg" alt="アルミフレーム20x40mm 660mm"></td>
            <td>2</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>フラットバー5mm</td>
            <td>2020年6月24日以降に出荷した製品には付属していません</td>
            <td><img src="./images/packing/flatbar.jpg" alt="フラットバー"/></td>
            <td>1</td>
        </tr>
    </tbody>
...
<table class="packing-list">
    <tbody>
        ...
        <tr>
            <td>レーザー電源</td>
            <td></td>
            <td><img src="./images/packing/PowerForLaser.jpg" alt="80Wレーザー電源"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>Utility BKT1</td>
...
<table class="packing-list">
    <tbody>
        ...
        <tr>
            <td>M4x6低頭ボルト</td>
            <td></td>
            <td><img src="./images/packing/143.jpg" alt="M4x6低頭ボルト"></td>
            <td>4</td>
        </tr>
        <tr>
            <td>M5x6低頭ボルト</td>
