...
FLD LにAC-MainケーブルをM3x10六角穴付皿ボルト2個とM3ナット2個で取り付け、パネルタッチコネクタも取り付けます。ポリウレタンチューブをパネルタッチコネクタに奥まで接続します。レーザーヘッド側のポリウレタンチューブが365ｍｍ出ているか確認し、パネルタッチコネクタ側のポリウレタンチューブが中継基板側に弛む場合はカットして長さを調整してください。
