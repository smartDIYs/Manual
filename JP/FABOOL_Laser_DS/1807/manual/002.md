...
<table class="packing-list">
    <tbody>
        ...
        <tr>
            <td>LED DCファン</td>
            <td></td>
            <td><img src="./images/packing/085.jpg" alt="LED DCファン"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>タンク</td>
        ...
        <tr>
            ...
            <td>一部の製品には端子取付部<br>
                （青色の部分）がオレンジ色の<br>
                部品が入っています</td>
            <td><img src="./images/packing/092.jpg" alt="非常停止ボタン"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>80mmDCファン</td>
        ...
        <tr>
            <td>スイッチング電源</td>
            <td></td>
            <td><img src="./images/packing/089.jpg" alt="スイッチング電源"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>水冷ポンプ</td>
        ...
        <tr>
            <td>タンク用ホース接続接手</td>
            <td></td>
            <td><img src="./images/packing/192.jpg" alt="タンク用ホース接続接手"></td>
            <td>2</td>
        </tr>
        <tr>
            <td>水冷ホース</td>
...
<table class="packing-list">
    <tbody>
        ...
        <tr>
            <td>Powerケーブル</td>
            <td></td>
            <td><img src="./images/packing/174.jpg" alt="Powerケーブル"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>Laserケーブル</td>
        ...
        <tr>
            <td>Y2-limitケーブル</td>
            <td></td>
            <td><img src="./images/packing/179.jpg" alt="Y2-limitケーブル"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>Y-Motor-Lケーブル</td>
        ...
        <tr>
            <td>sub boardケーブル</td>
            <td></td>
            <td><img src="./images/packing/184.jpg" alt="sub boardケーブル"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>Ground(L)ケーブル</td>
