...
<div style="background-color:#ffd; margin:12px;  padding:12px; color:#ff0000">
...
<div style="background-color:#eaeaea; margin:12px; padding:12px;">
...
<div style="background-color:#eaeaea; padding:12px;">
<div style="text-align:center; font-size:1.5em; margin:10px 0 20px;">Tips</div>
<br/>

Linux・Raspberry Piの場合、ソフトウェアを手動で起動する必要ございます。<br>
あらかじめ「run.sh」を実行してから「<a href="http://127.0.0.1:4444/">http://127.0.0.1:4444/</a>」にアクセスしてください。</strong>
</div>
