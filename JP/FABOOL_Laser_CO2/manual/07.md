<table class="packing-list">
    <tbody>
        ...
        <tr>
            ...
            <td>Inner acrylic</td>
            <td>機器取付済み</td>
            <td><img src="./images/07/packing-001.jpg" alt="Inner acrylic"></td>
            <td>1</td>
        </tr>
        <tr>
            <td>2</td>
...
「[Inner acrylic機器取り付け](https://www.smartdiys.com/)」で組み立てたInner acrylicを、アルミフレーム20mm角 145mmの溝にはめ込みます。取り付ける向きに注意してください。
