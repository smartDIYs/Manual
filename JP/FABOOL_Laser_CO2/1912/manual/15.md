...
### ケーブルキャリア配線
ポリウレタンチューブとX-Motorケーブルを、ケーブルキャリアに通しやすくするためにテープ等でまとめます。オプション品の位置決めキットをお持ちの方は、pointerケーブルを一緒にまとめます。※FABOOL Laser CO2 レーザーポインター付きレーザー管搭載にはpointerケーブルは必要ありません。
